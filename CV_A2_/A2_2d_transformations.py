...
def get_transformed_image(img, M):
    ...
    for i in range(img.shape[0]):
        for j in range(img.shape[1]):
            ...
            plane[int(x_prime)][int(y_prime)] = img[i][j]
...
_M[ord('a')] = np.array([[1., 0., 0.], [0., 1., -5.], [0., 0., 1.]])                # move left by 5 pixels
_M[ord('d')] = np.array([[1., 0., 0.], [0., 1., 5.], [0., 0., 1.]])                 # move right by 5 pixels
_M[ord('w')] = np.array([[1., 0., -5.], [0., 1., 0.], [0., 0., 1.]])                # move upward by 5 pixels
_M[ord('s')] = np.array([[1., 0., 5.], [0., 1., 0.], [0., 0., 1.]])                 # move downward by 5 pixels
...
while not end:
    ...
    if key == ord('H'):
        ...
        if key in _M:
            current_M = _M[key].dot(current_M)